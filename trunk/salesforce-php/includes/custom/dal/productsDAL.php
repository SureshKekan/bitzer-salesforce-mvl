...
class ProductsDAL extends SalesforceDAL
{
    function  __construct($sfClient)
    {
        $this->sfClient = $sfClient;
        $this->sfObject = "Product2";
    }

    public function selectProducts($queryString)
    {
        $this->query = "SELECT";
        ...
        if($this->params)
        {
            ...
            {
                $this->query .= " Id, Name, ProductCode, Description, IsActive";
                $this->query .= " FROM Product2";
            }
