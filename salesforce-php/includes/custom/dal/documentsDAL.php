...
class DocumentsDAL extends SalesforceDAL
{
    function  __construct($sfClient)
    {
        $this->sfClient = $sfClient;
        $this->sfObject = "Document";
    }

    public function selectDocuments($queryString)
    {
        $this->query = "SELECT";
        ...
        if($this->params)
        {
            ...
            {
                $this->query .= " Id, Name, Type, Description, URL, AuthorId";
                $this->query .= " FROM Document";
            }
