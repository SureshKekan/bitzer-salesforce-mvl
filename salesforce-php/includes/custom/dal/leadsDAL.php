...
class LeadsDAL extends SalesforceDAL
{
    ...
    public function selectLeads($queryString)
    {
        $this->query = "SELECT";
        ...
        if($this->params)
        {
            ...
            {
                $this->query .= " Id, Salutation, FirstName, LastName, Title, Company, Phone, Fax, MobilePhone, Street, City, PostalCode, Country, LeadSource, Status, LastActivityDate";
                $this->query .= " FROM Lead";
            }
