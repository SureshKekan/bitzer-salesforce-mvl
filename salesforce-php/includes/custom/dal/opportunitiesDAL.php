...
class OpportunitiesDAL extends SalesforceDAL
{
    function  __construct($sfClient)
    {
        $this->sfClient = $sfClient;
        $this->sfObject = "Opportunity";
    }

    public function selectOpportunities($queryString)
    {
        $this->query = "SELECT";
        ...
        if($this->params)
        {
            ...
            {
                $this->query .= " Id, Name, AccountId, Type, LeadSource, Amount, CloseDate, StageName, LastActivityDate";
