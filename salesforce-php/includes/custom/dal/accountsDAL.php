...
class AccountsDAL extends SalesforceDAL
{
    function  __construct($sfClient)
    {
        $this->sfClient = $sfClient;
        $this->sfObject = "Account";
    }

    public function selectAccounts($queryString)
    {
        $this->query = "SELECT";
        ...
        if($this->params)
        {
            ...
            {
                $this->query .= " Id, Name, Type, Industry, Website, Description, Phone, Fax, LastActivityDate";
